...
use app\model\Arttrip;
use League\Flysystem\Cached\Storage\PhpRedis;
use think\facade\Db;
use \Firebase\JWT\JWT;

class ArttripCt extends BaseController
{
    ...
    {
        $id = request()->param('id');
        $data = Arttrip::where('id', $id)->with('User')->with('Comment')->find();
        return ressend(200, '获取成功', $data);
    }
